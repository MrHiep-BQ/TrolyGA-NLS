...
<div class="main-header">
    ...
    <p>Tác giả: HOÀNG VĂN HIỆP - Trường Tiểu học Vô Điếm - SĐT: 0911 040 186</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - HOÀNG VĂN HIỆP - Trường Tiểu học Vô Điếm - SĐT: 0911 040 186</div>", unsafe_allow_html=True)
